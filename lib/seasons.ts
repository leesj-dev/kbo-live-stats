...
export const isValidSeason = (year: number) => year in REGULAR_SEASON_START_DATES;
...
export function seasonCrawlRange(season: number): { fromYmd: string; toYmd: string } | null {
